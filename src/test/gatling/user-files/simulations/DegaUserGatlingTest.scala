...
/**
 * Performance test for the DegaUser entity.
 */
class DegaUserGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the DegaUser entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all degaUsers")
            .get("/core/api/dega-users")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new degaUser")
            .post("/core/api/dega-users")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created degaUser")
                .get("/core${new_degaUser_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created degaUser")
            .delete("/core${new_degaUser_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
